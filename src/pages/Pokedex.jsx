  ...
  return (
    <main>
      <header className='pokedex__header'>
        <h1>Pokedex</h1>
        <p>welcome <span>{nameTrainer}</span>, here tou can find your favorite pokemon</p>
        <form onSubmit={handleSubmit} className='pokedex__form' action="">
          <div className='pokedex-search' >
            <input className='pokedex__input' type="text" id='namePokemon' />
            <button className='pokedex__btn' type='submit'>Search</button>
          </div>
          <select onChange={handleChangleSelect} className="pokedex__select">
